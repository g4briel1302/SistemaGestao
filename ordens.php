...
include_once 'banco.php';
    ...
    $sql = "SELECT * FROM  `ordens-serviço` ORDER BY id DESC";
    $result = $connection->query($sql);
    
    if(!empty($_GET['search']))
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM  `ordens-serviço` WHERE id LIKE '%$data%' or name LIKE '%$data%' or email LIKE '%$data%' ORDER BY id DESC";
    }
    else
    {
        $sql = "SELECT * FROM  `ordens-serviço` ORDER BY id DESC";
...
<head>
    ...
    <link rel="stylesheet" href="src/ordens.css">
...
<header>
        ...
        <div class="container">
            ...
            <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                ...
                <svg class="bi d-block mx-auto mb-1" xmlns="http://www.w3.org/2000/svg" width="26" height="24" fill="currentColor" class="bi bi-columns-gap" viewBox="0 0 16 16">
        ...
        <div class="container d-flex flex-wrap justify-content-center">
            ...
            <input type="search" style="width: 400px; border-radius:50px;" class="pesquisar" placeholder="Pesquisar" id="pesquisar">
            ...
            <button type="button" onclick="window.location.href = 'formulario.php'" class="btn btn-sm btn-success ">Nova Ordem</button>
    ...
    <div class="container-fluid">
        <div class="table table-bordered table-responsive p-2">
                ...
                <tbody >
                    <?php
                        ...
                        while($user_data = mysqli_fetch_assoc($result))
                        {
                            ...
                            echo "<td>" . $user_data['acessorio'] . "</td>";
                            echo "<td> 
                                ...
                                <a class='btn btn-sm btn-primary' data-bs-toggle='modal' data-bs-target='#exampleModal'>
...
<script>
    ...
    function searchData()
    {
        window.location = 'ordens.php?search='+search.value;
    }
</script>
</html>